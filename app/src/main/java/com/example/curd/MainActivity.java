        ...
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!editRollNumber.getText().toString().isEmpty()) {
                    ...
                    boolean search = db.delete(Integer.parseInt(editRollNumber.getText().toString()));
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!editName.getText().toString().isEmpty() && !editRollNumber.getText().toString().isEmpty()) {
                    DBHelper db = new DBHelper(MainActivity.this);
                    boolean search = db.update(Integer.parseInt(editRollNumber.getText().toString()),editName.getText().toString());
